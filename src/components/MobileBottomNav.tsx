...
export const MobileBottomNav = ({ onTabChange, activeTab = 'player' }: MobileBottomNavProps) => {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-card border-t-2 border-border z-40 shadow-2xl">
      <div className="flex justify-around items-center h-16 px-1 max-w-lg mx-auto">
        ...
        >
          <Radio className={cn("h-4 w-4", activeTab === 'player' && "scale-110")} />
        ...
        >
          <History className={cn("h-4 w-4", activeTab === 'history' && "scale-110")} />
        ...
        >
          <Flame className={cn("h-4 w-4", activeTab === 'hot40' && "scale-110")} />
        ...
        >
          <Mic className={cn("h-4 w-4", activeTab === 'shows' && "scale-110")} />
        ...
        >
          <Heart className={cn("h-4 w-4", activeTab === 'support' && "scale-110 fill-current")} />
